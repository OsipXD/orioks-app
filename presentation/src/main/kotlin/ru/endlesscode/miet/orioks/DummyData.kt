...
object DummyData {
    ...
    private val usersSubjects = arrayOf(
            listOf(
                    ...
                    Subject("Нейронные сети", "Кафедра информатики и программного обеспечения вычислительных систем", 56, listOf("Рычагов Михаил Николаевич"), SubjectForm.GRADED_CREDIT, true)
            ),
            listOf(
                    ...
                    Subject("Нейронные сети", "Кафедра информатики и программного обеспечения вычислительных систем", 60, listOf("Рычагов Михаил Николаевич"), SubjectForm.GRADED_CREDIT, true)
            )
    )
